//#region node_modules/.nitro/vite/services/ssr/assets/team-BiOD2sUZ.js
var omjee_default = "/assets/omjee-CJ-rf0MU.jpg";
var gyanendra_default = "/assets/gyanendra-gRy-CehV.jpg";
var mallick_default = "/assets/mallick-D33mDkBP.jpg";
var categoryMeta = {
	members: {
		label: "Project Members",
		blurb: "The builders shipping the bureau."
	},
	mentors: {
		label: "Mentors",
		blurb: "Academic guidance on AI, scoring & XAI."
	},
	advisors: {
		label: "Advisors",
		blurb: "Strategic & institutional direction."
	}
};
var team = [
	{
		...
		highlights: [
			{
				label: "Role",
				value: "Senior Advisor · Proposal Originator"
			},
			{
				label: "Institution",
				value: "BIT Mesra"
			...
			{
				label: "Focus",
				value: "Governance · Strategy · AI Systems"
			},
			{
				label: "Contribution",
				value: "Core idea & proposal direction"
			}
		]
	},
	{
		...
		highlights: [
			...
			{
				label: "Focus",
				value: "Explainable AI · ML"
			},
			{
				label: "Contribution",
				value: "Scoring & XAI guidance"
			}
		]
	},
	{
		...
		highlights: [
			...
			{
				label: "Role",
				value: "Founder · CEO · Chief Architect"
			}
		]
	}
];
//#endregion
export { team as n, categoryMeta as t };
